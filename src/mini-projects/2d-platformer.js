    ...
    const scrollSpeedRef = useRef(0); // Initial scroll speed
      ...
      function arrowKeys() {
        ...
        if (currentKeys.ArrowUp) {
          if (touchingGroundRef.current) { // Assuming touchingGroundRef is a ref that tracks whether the player is touching the ground
      ...
      function display() {
        ...
        if (guyRef.current) {
          ...
          guyRef.current.style.left = (playerPosXRef.current - scrollXRef.current) * ratio + "px";
